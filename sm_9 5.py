...
class Gardener: #инициализация объекта Gardener
    ...
    def work(self):
        ...
        #print("Ухаживаем за кустом с томатами")
...
bush = TomatoBush(4) # создание куста с четырьмя томатами
gardener = Gardener('Екатерина', bush) # создание садовника и назначение его на куст томатов
gardener.work() #ухаживание за кустом
#gardener.harvest()#сбор урожая, когда томаты не созрели
gardener.work() #продолжаем ухаживать за кустом
gardener.work()
gardener.harvest()#сбор урожая, когда томаты созрели